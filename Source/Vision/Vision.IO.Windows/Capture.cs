...
{
    /// <summary>
    /// Video capture class. (I NEED HELP WITH THIS). TODO: This implementation should be in separate assembly (i.e. - regarding how many architectures should be supported) if the Accord.Extensions.NET should be used on different architectures.
    /// </summary>
