...
namespace ParticleFilterModelFitting
{
    public partial class ParticleFilterModelFittingDemo : Form
    {
        ...
        IEnumerable<Particle<ParticleState>> bestParticles;
                ...
                Resampler = (particles) => 
                            {
                                ...
                                var sampleParticles = FilterMethods<Particle<ParticleState>, ParticleState>.SimpleResampler();
        ...
        private void exec(Image<Bgr, byte> img)
        {
            ...
            sortedParticles.Take(10).ForEach(x => x.State.HandTemplate.Draw(img));
        ...
        void videoCapture_ProcessFrame(object sender, EventArgs e)
        {
            ...
            frame = videoCapture.QueryFrame();//.GetSubRect(new Rectangle(30, 200, 200, 200));
