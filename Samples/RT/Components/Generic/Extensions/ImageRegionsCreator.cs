...
namespace RT
{
    public static class ImageRegionsCreatorExtension
    {
        ...
        public static List<Rectangle> GenerateRegions(this Size areaSize, Size startSize, Size endSize, float scale, int dX, int dY)
        {
            if (dX <= 0 || dY <= 0)
        ...
        /// </param>
        /// <returns> The collection of regions.</returns>
        public static List<Rectangle> GenerateRegions(this Size areaSize, Size startSize, Size endSize, float scale, Func<Rectangle, float, Size> stepFunc)
        {
            validateProperties(startSize, endSize, scale);
            return generateWindows(areaSize, startSize, endSize, scale, stepFunc);
        }

        private static List<Rectangle> generateWindows(Size imageSize, Size startSize, Size endSize, float scale, Func<Rectangle, float, Size> stepFunc)
        {
        ...
        private static IEnumerable<float> generateScales(Size imageSize, Size startSize, Size endSize, float scale)
        {
        ...
        private static void validateProperties(Size startSize, Size endSize, float scale)
        {
