...
namespace RT
{
    ...
    public class PicoClassifier
    {
        ...
        public PicoClassifier(float windowWidthMultiplier = 1)
            :this(windowWidthMultiplier, new Cascade<StageClassifier>())
        {}
        ...
        public PicoClassifier(float windowWidthMultiplier, Cascade<StageClassifier> cascade)
        {
        ...
        /// <param name="regionScale">Region scale.</param>
        ...
        public bool ClassifyRegion(MyImage image, Point regionCenter, int regionScale, out float confidence, int angleDeg = 0)
        {
            var regionSize = new Size 
            {
                Width = (int)(regionScale * this.WindowWidthMultiplier),
                Height = regionScale
            };
        ...
        {
            float confidence;
            bool isTruePositive = this.ClassifyRegion(imgSample.Image, imgSample.ROI.Center(), imgSample.ROI.Width, out confidence);
